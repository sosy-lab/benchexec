...
and these [ACM SIGSOFT Empirical Standards for Benchmarking](https://github.com/acmsigsoft/EmpiricalStandards/blob/master/docs/standards/Benchmarking.md). <!-- codespell:ignore master -->
