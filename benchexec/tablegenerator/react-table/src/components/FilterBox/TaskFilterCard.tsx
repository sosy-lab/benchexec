...
let debounceHandler: NodeJS.Timeout = setTimeout(() => {}, 500);
...
export default class TaskFilterCard extends PureComponent<TaskFilterCardProps, TaskFilterCardState> {
    ...
    sendFilterUpdate(values: Record<string, string>): void {
        this.props.updateFilters(values);
    }

    extractFilters(): Record<string, string> {
        let i = 0;
    ...
    render() {
        ...
        const makeFilterBody = (): JSX.Element => {
