             ...
             <div className = "info">
                ...
                <h3>Summary:</h3> 
                    <ul>
                        ...
                        <li><strong>Select columns:</strong> <br/> To customize your columns, click on the field on the left side "Click here to select columns" or <span className = "link" onClick={this.props.selectColumn}>here</span>.</li>
