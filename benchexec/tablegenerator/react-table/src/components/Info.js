    ...
    render() {
        ...
        return (
             <div className = "info">
                ...
                <h3>Reset Filters</h3>
                    <ul>
                        <li>At every time you can reset all your the filters you have set in the table</li>
                    </ul>
                <h3>Questions and Feedback </h3>
                <span>Write an e-Mail to <a href="mailto:laura.bschor@t-online.de?subject=[HTMLResultTablegenerator]">Laura Bschor</a> or <a href="mailto:wendler@sosy.ifi.lmu.de?subject=[HTMLResultTablegenerator]">Dr. Philipp Wendler</a></span>
                <p>Generated by <a href="https://github.com/sosy-lab/benchexec" target="_blank" rel="noopener noreferrer"> BenchExec</a></p>
            </div>
        )
    }
}