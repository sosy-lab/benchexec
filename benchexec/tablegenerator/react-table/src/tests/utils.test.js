 ...
 */
import {applyNumericFilter, isOkStatus, numericSortMethod, textSortMethod} from "../utils/utils";
...
const getFilteredData = regex => rows.filter(row => applyNumericFilter({id: "test", value: regex}, row));
