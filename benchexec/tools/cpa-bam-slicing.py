...
class Tool(benchexec.tools.template.BaseTool):
    """
    Tool info for CPAchecker with a wrapper enabling preprocessing
    with region-based reachability slicer implemented as a Frama-C plugin.
    ...
    def executable(self):
        executable = util.find_executable('wrapper.sh')
    ...
    def version(self, executable):
        stdout = self._version_from_tool(util.find_executable('cpa.sh', 'scripts/cpa.sh'), '-help')
