...
class Tool(benchexec.tools.template.BaseTool):
    """
    Tool info for PeSCo.
    It is based on tool info for CPAchecker. Therefore
    it reuses same features.
    """
    ...
    def _buildCPAchecker(self, executableDir):
        logging.debug('Building PeSCo in directory {0}.'.format(executableDir))
